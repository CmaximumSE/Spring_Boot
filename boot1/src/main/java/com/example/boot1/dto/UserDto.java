...
//@NoArgsConstructor // argument가 없는 기본 생성자를 자동으로 만들어 줌.
//@AllArgsConstructor // 모든 필드를 파라미터로 선언한 생성자를 자동으로 만들어 줌.
//@ToString // toString 메서드를 재정의(override).
//@Setter // final이 아닌 모든 필드의 setter 메서드를 자동으로 만들어 줌.
//@Getter // 모든 필드의 getter 메서드를 자동으로 만들어 줌.
